...
class BookingApiTest extends TestCase
{
        ...
        $response = $this->postJson('/api/bookings/summary', [
            ...
            'passengers' => [
                [
                    ...
                    'passport_number' => 'A12345678',
                    'passport_expiry' => now()->subYear()->format('Y-m-d'), // Expired
                ],
            ],
        ]);
    ...
    */
    ...
    public function test_can_checkout_with_valid_token(): void
    {
        ...
        $summaryResponse = $this->postJson('/api/bookings/summary', [
            'flight_id' => $this->flight->id,
            'passengers' => [
                [
                    'title' => 'Mr',
        ...
        $bookingToken = $summaryResponse->json('data.booking_token');
